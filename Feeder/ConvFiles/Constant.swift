...
struct Constant {
   ...
   static let SHOW_STORY_SEGUEI = "showStorySeguei"
   public static let HACKING_WITH_SWIFT_URL = "https://www.hackingwithswift.com/articles/rss"
   public static let SCIENCE_FEED = "https://www.popsci.com/rss-science.xml?loc=contentwell&lnk=science&dom=section-1"
...
struct CoreDataConstant {
   ...
   static let UINIQE_ID_PROPERTY = "uid"
   static let STORY_IMAGE_PROPERTY = "image"
}
